...
\begin{abstract}
In this article we discuss an implementation of the Kalman-filter \cite{kalman} to improve measurement quality and predict the movement of balls on a pool table. 
...
In the end we compared the performaces of each filter implementation.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.47\textwidth]{filter_comparison.PNG}}
